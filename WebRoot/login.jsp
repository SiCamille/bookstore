...
<title>CAMILLE书城</title>
	<script type = "text/javascript">
		...
		function change() {
			document.getElementById("img").src = "${pageContext.request.contextPath}/imgCode?time="
				+ new Date().getTime();
		}
...
<body>
	<%-- 2016-11-30 8:23:14 --%>
	<h1 class = "welcome" align="center">卡米尔书城欢迎你</h1>
	<div class = "back">
		<form action="${pageContext.request.contextPath}/login" method="post" onsubmit="return check()">
			...
			<div class = "loginDiv" id = "codeDiv">
				...
				<img src = "${pageContext.request.contextPath}/imgCode" class = "img" id = "img" style="vertical-align: middle;" onclick = "change()">
			...
			<div class = "mistake_msg">${requestScope["mistake"] }</div>
